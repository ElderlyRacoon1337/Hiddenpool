...
export const AuthPopup = ({ popupOpen, handleClosePopup }: any) => {
  ...
  const [isHiddenPasswordLogin, setIsHiddenPasswordLogin] = useState(true);
      ...
      {isLogin ? (
        ...
        >
          ...
          <div className="df fdc">
            ...
            />
            <Button variant="contained" disabled className="mb-10px">
              Продолжить
            </Button>
        ...
        >
          ...
          <div className="df fdc">
            ...
            />
            <Button disabled variant="contained" className="mb-10px">
              Продолжить
            </Button>
            <div className="df jcsb">
              <div className="">
